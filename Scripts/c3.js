(function (window) {
    ...
    c3_chart_internal_fn.getTooltipContent = function (d, defaultTitleFormat, defaultValueFormat, color) {
        ...
        for (i = 0; i < d.length; i++) {
            ...
            {
                var vall=value.toString();
                valueZei=format(vall);;
            }
            if (value !== undefined) {
                ...
                text += "<td class='value'>" + valueZei + "</td>";
                text += "</tr>";
            }
        }
        return text + "</table>";
    ...
    function format(val)
    {
        ...
        var s;//add by Ravi
// make it a Stringvar s = 0;
        if( n.indexOf("-") > -1 ) s=1; // negative ?
        else //add by Ravi
            s=0;//add by Ravi
        for( var i = n.length-3; i > s; i-=3 )
